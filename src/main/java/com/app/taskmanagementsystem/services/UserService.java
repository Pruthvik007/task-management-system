...
public interface UserService {
    ...
    Page<Task> getTasks(String searchTerm, Task.TaskStatus status, Task.TaskPriority priority, LocalDateTime dueDateFrom, LocalDateTime dueDateUntil, int pageNo);
